...
public class SetCagePosition extends Command {
  ...
  public SetCagePosition(Elevator elevator, Elbow elbow, Wrist wrist) {
    this.elevator = elevator;
    this.elbow = elbow;
    this.wrist = wrist;
    this.position = Constants.PositionConstants.CAGE;
