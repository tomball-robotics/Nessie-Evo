...
public class SetSourcePosition extends Command {
  ...
  public SetSourcePosition(Elevator elevator, Elbow elbow, Wrist wrist) {
    this.elevator = elevator;
    this.elbow = elbow;
    this.wrist = wrist;
    this.position = Constants.PositionConstants.SOURCE;
