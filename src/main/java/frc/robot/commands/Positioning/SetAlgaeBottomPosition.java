...
public class SetAlgaeBottomPosition extends Command {
  ...
  public SetAlgaeBottomPosition(Elevator elevator, Elbow elbow, Wrist wrist) {
    this.elevator = elevator;
    this.elbow = elbow;
    this.wrist = wrist;
    this.position = Constants.PositionConstants.BOTTOM_ALGAE;
