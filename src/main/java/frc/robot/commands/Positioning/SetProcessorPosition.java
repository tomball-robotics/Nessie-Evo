...
public class SetProcessorPosition extends Command {
  ...
  public SetProcessorPosition(Elevator elevator, Elbow elbow, Wrist wrist) {
    this.elevator = elevator;
    this.elbow = elbow;
    this.wrist = wrist;
    this.position = Constants.PositionConstants.PROCESSOR;
